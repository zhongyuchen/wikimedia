...
*/
    ...
    public static class PositionalIndexMapper extends Mapper<LongWritable, Text, Text, Text>{
...
*/
            ...
            for (String w: words) {
                if (w != null && w.length() != 0) {
                    ...
                    if (split.length == 2) {
                        keyInfo.set(split[0] + "-" + id);
                        valueInfo.set(split[1]);
                        // key: word + id
                        // value: position
                        context.write(keyInfo, valueInfo);
                    }
    ...
    public static class PositionalIndexCombiner extends Reducer<Text, Text, Text, Text> {
        ...
        public void reduce(Text key, Iterable<Text> values, Context context) throws IOException, InterruptedException {
            ...
            keyInfo.set(split[0]);
            valueInfo.set(split[1] + "-" + length.toString() + "-" + posList.substring(0, posList.length() - 1));
            // key: word
...
//		private Text keyInfo = new Text();
    ...
    public static void main(String[] args) throws Exception {
        ...
        Job job = Job.getInstance(conf, PositionalIndex.class.getName());
