...
public class PosKeyTFID {
    ...
    public static class PosKeyTFIDMapper extends Mapper<LongWritable, Text, TripletWritable, Text>{
...
//            String title = slice(page, "<title></title>");
    ...
    public static class PosKeyTFIDReducer extends Reducer<TripletWritable, Text, Text, Text> {
    ...
    public static void main(String[] args) throws Exception {
        ...
        Job job = Job.getInstance(conf, PosKeyTFID.class.getName());
        job.setJarByClass(PosKeyTFID.class);
        job.setNumReduceTasks(15);

        job.setInputFormatClass(XmlInputFormat.class);
        job.setOutputFormatClass(TextOutputFormat.class);

        job.setMapperClass(PosKeyTFIDMapper.class);
        job.setMapOutputKeyClass(TripletWritable.class);
        job.setMapOutputValueClass(Text.class);

        job.setGroupingComparatorClass(TripletComparator.class);
        job.setReducerClass(PosKeyTFIDReducer.class);
